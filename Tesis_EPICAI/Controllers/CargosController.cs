...
namespace Tesis_EPICAI.Controllers
{
    ...
    public class CargosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Salario,Descripcion")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Salario,Descripcion")] Cargo cargo)
        {
            if (id != cargo.Id)
            {
                return NotFound();
